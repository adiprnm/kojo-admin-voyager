                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-2' style='margin-bottom: 10px'>
                                                            <div class='form-group'>
                                                                ...
                                                                <input class='form-control' name="detail[{{ $k }}][type]" value='{{ $item->type }}'>
                                                            </div>
                                                        </div>
                                                        <div class='col-md-2' style='margin-bottom: 10px'>
                                                            <div class='form-group'>
                                                                <label for="Bahan">Bahan</label>
                                                                <input class='form-control' name="detail[{{ $k }}][material]" value='{{ $item->material }}'>
                                                            </div>
                                                        </div>
                                                        <div class='col-md-2' style='margin-bottom: 10px'>
                                                            <div class='form-group'>
                                                                <label for="Jenis Lengan">Jenis Lengan</label>
                                                                <input class='form-control' name="detail[{{ $k }}][sleeve]" value='{{ $item->sleeve }}'>
                                                            </div>
                                                        </div>
                                                        <div class='col-md-2' style='margin-bottom: 10px'>
                                                            <div class='form-group'>
                                                                <label for="Ukuran">Ukuran</label>
                                                                <input class='form-control' name="detail[{{ $k }}][size]" value='{{ $item->size }}'>
                                                            </div>
                                                        </div>
                                                        <div class='col-md-2' style='margin-bottom: 10px'>
                                                            <div class='form-group'>
                                                                <label for="Jumlah">Jumlah</label>
                                                                <input class='form-control' name="detail[{{ $k }}][quantity]" value='{{ $item->quantity }}'>
                                                            </div>
                                                        </div>
                                                        <div class='col-md-2' style='margin-bottom: 10px'>
                                                            <div class='form-group'>
                                                                <label for="Harga">Harga</label>
                                                                <input class='form-control' name="detail[{{ $k }}][price]" value='{{ $item->price }}'>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endforeach
